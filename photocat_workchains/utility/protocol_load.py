...
OX_STATE = Any(NUMBER,list,str,OX_STATE_TYPES)
ELEMENT = Any(
    'H',
    'He',
    'Li',
...
ISOTHERM_PROTOCOL_SCHEMA = Schema(
    {
        ...
        Optional('basis_set_aux'): {
            ELEMENT: str,
        },
        Optional(Match('hubbard_l')):
            SETTINGS_SCHEMA,
        Optional(Match('hubbard_u')):
            SETTINGS_SCHEMA,
        Optional(Match('open_shell_spin')):
            SETTINGS_SCHEMA,
        'pseudopotential': {
            ELEMENT: str,
        },
